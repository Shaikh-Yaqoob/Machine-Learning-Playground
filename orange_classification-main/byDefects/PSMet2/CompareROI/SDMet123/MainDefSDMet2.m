...
pathAplicacion=strcat(pathPrincipal,'tmpToLearn/SDMet2/'); %
...
for n=1:size(listado)
    ...
    ExtractDefDetectImgSoftSDMet2(pathEntradaImagenesTest, pathAplicacion, nombreImagenP, archivoVectorDef, tamanoManchas)
    %if n==1
    %    break;
    %end %if n==11
end %
